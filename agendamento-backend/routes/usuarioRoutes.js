    ...
    const verificarToken = require('../middlewares/verificarToken');  // Middleware para verificar o token
    ...
    // Rota para atualizar o perfil do usuário (upload de foto)
    ...
    try { 
        ...
        const usuarioAtualizado = await Usuario.findByIdAndUpdate(userId, atualizacao, { new: true });
